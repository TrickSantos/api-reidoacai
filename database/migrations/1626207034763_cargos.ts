...
export default class Cargos extends BaseSchema {
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.string('nome')
      table.json('pdv').defaultTo(JSON.stringify(base))
      table.json('os').defaultTo(JSON.stringify(base))
      table.json('produtos').defaultTo(JSON.stringify(base))
      table.json('servicos').defaultTo(JSON.stringify(base))
      ...
      table.json('compras').defaultTo(JSON.stringify(base))
