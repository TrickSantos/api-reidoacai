...
Route.resource('/fornecedor', 'FornecedoresController').apiOnly().middleware({ '*': 'auth' })
Route.resource('/produto', 'ProdutosController').apiOnly().middleware({ '*': 'auth' })
...
Route.put('/add_produto/:id', 'PedidosController.addAdicional').middleware('auth')
Route.put('/remove_produto/:id', 'PedidosController.removeAdicional').middleware('auth')
